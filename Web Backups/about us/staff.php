		...
		<div id="main-cont">
			...
			<div id="main">
				...
				<div id="interior-wide-text-cont">
					...
					<div id="staff">
						<div class="staff-box">
						  <p>Sharon Thomas<br /><em>Franchisee</em></p></div>
						<div class="staff-box">
						  <p>Bobbi Townsend<br /><em>Student Counselor, Instructor</em></p></div>
						<div class="staff-box">
						  <p>Katy Oyler<br /><em>Instructor</em></p></div>
						<div class="staff-box">
						  <p>Christie McClary<br /><em>Instructor</em></p></div>
						<div class="staff-box">
						  <p>Ron Townsend<br /><em>Instructor</em></p></div>
						<div class="staff-box">
						  <p>Rafael Dueno<br /><em>Instructor</em></p></div>
					</div>
				</div>
